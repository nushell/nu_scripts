...
@example "generate a message authentication code" {"The quick brown fox jumps over the lazy dog" | hmac sha256 --key "key" | encode hex} --result "F7BC83F430538424B13298E6AA6FB143EF4D59A14946175997479DBC2D1A3CD8"
