...
extern "iex" [
	...
	--name					# Make & assign a name to the distributed node
	--sname					# Make & assign a short name to the distributed node
	--cookie					# Sets a cookie for this distributed node
	--hidden					# Makes a hidden node
	--detached					# Starts the Erlang VM detached from console
	--remsh					# Connects to a node using a remote shell
	--dot-iex					# Overrides default .iex file and uses path instead
	...args
]