...
extern "dotnet" [
	...
	--additional-deps					# Path to additional deps.json
	--depsfile					# Path to deps.json
	--fx-version					# Version of the .NET runtime to use
	--runtimeconfig					# Path to runtimeconfig.json
