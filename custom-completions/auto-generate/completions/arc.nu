...
extern "arc" [
	...
	--no-ansi					# Don\'t
	--ansi					# Always use formatting
	--no-ansi					# Don\'t
	--load-phutil-library					# Specify which libraries to load
	--conduit-uri					# Specify the Conduit URI
	--conduit-token					# Specify the Conduit token
	--conduit-version					# Force a version
	--conduit-timeout					# Sets the timeout
	--config					# Sets a config
	--skip-arcconfig					# Skip the working copy configuration file
	--arcrc-file					# Use provided file instead of ~/.arcrc
