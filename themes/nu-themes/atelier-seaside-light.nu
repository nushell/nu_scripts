export module "atelier-seaside-light-theme" {
...
export module activate {
    export-env {
        use "atelier-seaside-light-theme"

        atelier-seaside-light-theme set color_config
        atelier-seaside-light-theme update terminal
    }
}
