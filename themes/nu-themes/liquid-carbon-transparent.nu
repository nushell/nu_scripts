export module "liquid-carbon-transparent-theme" {
...
export module activate {
    export-env {
        use "liquid-carbon-transparent-theme"

        liquid-carbon-transparent-theme set color_config
        liquid-carbon-transparent-theme update terminal
    }
}
