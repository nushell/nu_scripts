export module "gruvbox-material-dark-soft-theme" {
...
export module activate {
    export-env {
        use "gruvbox-material-dark-soft-theme"

        gruvbox-material-dark-soft-theme set color_config
        gruvbox-material-dark-soft-theme update terminal
    }
}
