export module "gruvbox-mix-light-hard-theme" {
...
export module activate {
    export-env {
        use "gruvbox-mix-light-hard-theme"

        gruvbox-mix-light-hard-theme set color_config
        gruvbox-mix-light-hard-theme update terminal
    }
}
