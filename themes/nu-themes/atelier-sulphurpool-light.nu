export module "atelier-sulphurpool-light-theme" {
...
export module activate {
    export-env {
        use "atelier-sulphurpool-light-theme"

        atelier-sulphurpool-light-theme set color_config
        atelier-sulphurpool-light-theme update terminal
    }
}
