export module "gruvbox-material-light-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-material-light-medium-theme"

        gruvbox-material-light-medium-theme set color_config
        gruvbox-material-light-medium-theme update terminal
    }
}
