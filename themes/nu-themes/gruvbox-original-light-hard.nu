export module "gruvbox-original-light-hard-theme" {
...
export module activate {
    export-env {
        use "gruvbox-original-light-hard-theme"

        gruvbox-original-light-hard-theme set color_config
        gruvbox-original-light-hard-theme update terminal
    }
}
