export module "black-metal-immortal-theme" {
...
export module activate {
    export-env {
        use "black-metal-immortal-theme"

        black-metal-immortal-theme set color_config
        black-metal-immortal-theme update terminal
    }
}
