export module "equilibrium-gray-light-theme" {
...
export module activate {
    export-env {
        use "equilibrium-gray-light-theme"

        equilibrium-gray-light-theme set color_config
        equilibrium-gray-light-theme update terminal
    }
}
