export module "atelier-lakeside-light-theme" {
...
export module activate {
    export-env {
        use "atelier-lakeside-light-theme"

        atelier-lakeside-light-theme set color_config
        atelier-lakeside-light-theme update terminal
    }
}
