export module "solarized-dark-higher-contrast-theme" {
...
export module activate {
    export-env {
        use "solarized-dark-higher-contrast-theme"

        solarized-dark-higher-contrast-theme set color_config
        solarized-dark-higher-contrast-theme update terminal
    }
}
