export module "atelier-heath-light-theme" {
...
export module activate {
    export-env {
        use "atelier-heath-light-theme"

        atelier-heath-light-theme set color_config
        atelier-heath-light-theme update terminal
    }
}
