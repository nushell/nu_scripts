export module "gruvbox-mix-dark-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-mix-dark-medium-theme"

        gruvbox-mix-dark-medium-theme set color_config
        gruvbox-mix-dark-medium-theme update terminal
    }
}
