export module "gruvbox-dark-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-dark-medium-theme"

        gruvbox-dark-medium-theme set color_config
        gruvbox-dark-medium-theme update terminal
    }
}
