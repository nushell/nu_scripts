export module "gruvbox-material-dark-hard-theme" {
...
export module activate {
    export-env {
        use "gruvbox-material-dark-hard-theme"

        gruvbox-material-dark-hard-theme set color_config
        gruvbox-material-dark-hard-theme update terminal
    }
}
