export module "synth-midnight-light-theme" {
...
export module activate {
    export-env {
        use "synth-midnight-light-theme"

        synth-midnight-light-theme set color_config
        synth-midnight-light-theme update terminal
    }
}
