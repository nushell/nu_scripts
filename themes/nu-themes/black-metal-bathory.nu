export module "black-metal-bathory-theme" {
...
export module activate {
    export-env {
        use "black-metal-bathory-theme"

        black-metal-bathory-theme set color_config
        black-metal-bathory-theme update terminal
    }
}
