export module "github-light-colorblind-theme" {
...
export module activate {
    export-env {
        use "github-light-colorblind-theme"

        github-light-colorblind-theme set color_config
        github-light-colorblind-theme update terminal
    }
}
