export module "black-metal-gorgoroth-theme" {
...
export module activate {
    export-env {
        use "black-metal-gorgoroth-theme"

        black-metal-gorgoroth-theme set color_config
        black-metal-gorgoroth-theme update terminal
    }
}
