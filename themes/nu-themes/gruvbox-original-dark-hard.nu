export module "gruvbox-original-dark-hard-theme" {
...
export module activate {
    export-env {
        use "gruvbox-original-dark-hard-theme"

        gruvbox-original-dark-hard-theme set color_config
        gruvbox-original-dark-hard-theme update terminal
    }
}
