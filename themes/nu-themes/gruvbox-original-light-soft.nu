export module "gruvbox-original-light-soft-theme" {
...
export module activate {
    export-env {
        use "gruvbox-original-light-soft-theme"

        gruvbox-original-light-soft-theme set color_config
        gruvbox-original-light-soft-theme update terminal
    }
}
