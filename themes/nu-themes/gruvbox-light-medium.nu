export module "gruvbox-light-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-light-medium-theme"

        gruvbox-light-medium-theme set color_config
        gruvbox-light-medium-theme update terminal
    }
}
