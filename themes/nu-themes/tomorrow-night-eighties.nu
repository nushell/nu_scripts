export module "tomorrow-night-eighties-theme" {
...
export module activate {
    export-env {
        use "tomorrow-night-eighties-theme"

        tomorrow-night-eighties-theme set color_config
        tomorrow-night-eighties-theme update terminal
    }
}
