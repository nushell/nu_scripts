export module "gruvbox-original-light-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-original-light-medium-theme"

        gruvbox-original-light-medium-theme set color_config
        gruvbox-original-light-medium-theme update terminal
    }
}
