export module "gruvbox-mix-light-soft-theme" {
...
export module activate {
    export-env {
        use "gruvbox-mix-light-soft-theme"

        gruvbox-mix-light-soft-theme set color_config
        gruvbox-mix-light-soft-theme update terminal
    }
}
