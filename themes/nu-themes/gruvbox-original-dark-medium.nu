export module "gruvbox-original-dark-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-original-dark-medium-theme"

        gruvbox-original-dark-medium-theme set color_config
        gruvbox-original-dark-medium-theme update terminal
    }
}
