export module "spacegray-eighties-dull-theme" {
...
export module activate {
    export-env {
        use "spacegray-eighties-dull-theme"

        spacegray-eighties-dull-theme set color_config
        spacegray-eighties-dull-theme update terminal
    }
}
