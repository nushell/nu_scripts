export module "horizon-terminal-light-theme" {
...
export module activate {
    export-env {
        use "horizon-terminal-light-theme"

        horizon-terminal-light-theme set color_config
        horizon-terminal-light-theme update terminal
    }
}
