export module "gruvbox-mix-dark-hard-theme" {
...
export module activate {
    export-env {
        use "gruvbox-mix-dark-hard-theme"

        gruvbox-mix-dark-hard-theme set color_config
        gruvbox-mix-dark-hard-theme update terminal
    }
}
