export module "windows-highcontrast-theme" {
...
export module activate {
    export-env {
        use "windows-highcontrast-theme"

        windows-highcontrast-theme set color_config
        windows-highcontrast-theme update terminal
    }
}
