export module "gruvbox-mix-light-medium-theme" {
...
export module activate {
    export-env {
        use "gruvbox-mix-light-medium-theme"

        gruvbox-mix-light-medium-theme set color_config
        gruvbox-mix-light-medium-theme update terminal
    }
}
