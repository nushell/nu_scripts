export module "github-light-default-theme" {
...
export module activate {
    export-env {
        use "github-light-default-theme"

        github-light-default-theme set color_config
        github-light-default-theme update terminal
    }
}
