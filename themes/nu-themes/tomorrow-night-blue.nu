export module "tomorrow-night-blue-theme" {
...
export module activate {
    export-env {
        use "tomorrow-night-blue-theme"

        tomorrow-night-blue-theme set color_config
        tomorrow-night-blue-theme update terminal
    }
}
