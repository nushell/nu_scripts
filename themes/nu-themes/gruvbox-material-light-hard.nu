export module "gruvbox-material-light-hard-theme" {
...
export module activate {
    export-env {
        use "gruvbox-material-light-hard-theme"

        gruvbox-material-light-hard-theme set color_config
        gruvbox-material-light-hard-theme update terminal
    }
}
