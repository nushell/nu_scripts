export module "windows-highcontrast-light-theme" {
...
export module activate {
    export-env {
        use "windows-highcontrast-light-theme"

        windows-highcontrast-light-theme set color_config
        windows-highcontrast-light-theme update terminal
    }
}
