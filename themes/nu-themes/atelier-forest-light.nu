export module "atelier-forest-light-theme" {
...
export module activate {
    export-env {
        use "atelier-forest-light-theme"

        atelier-forest-light-theme set color_config
        atelier-forest-light-theme update terminal
    }
}
