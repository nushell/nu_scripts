export module "github-dark-colorblind-theme" {
...
export module activate {
    export-env {
        use "github-dark-colorblind-theme"

        github-dark-colorblind-theme set color_config
        github-dark-colorblind-theme update terminal
    }
}
