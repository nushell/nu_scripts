export module "gruvbox-material-light-soft-theme" {
...
export module activate {
    export-env {
        use "gruvbox-material-light-soft-theme"

        gruvbox-material-light-soft-theme set color_config
        gruvbox-material-light-soft-theme update terminal
    }
}
