export module "horizon-terminal-dark-theme" {
...
export module activate {
    export-env {
        use "horizon-terminal-dark-theme"

        horizon-terminal-dark-theme set color_config
        horizon-terminal-dark-theme update terminal
    }
}
