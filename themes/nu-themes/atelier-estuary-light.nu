export module "atelier-estuary-light-theme" {
...
export module activate {
    export-env {
        use "atelier-estuary-light-theme"

        atelier-estuary-light-theme set color_config
        atelier-estuary-light-theme update terminal
    }
}
