export module "equilibrium-gray-dark-theme" {
...
export module activate {
    export-env {
        use "equilibrium-gray-dark-theme"

        equilibrium-gray-dark-theme set color_config
        equilibrium-gray-dark-theme update terminal
    }
}
