export module "synth-midnight-dark-theme" {
...
export module activate {
    export-env {
        use "synth-midnight-dark-theme"

        synth-midnight-dark-theme set color_config
        synth-midnight-dark-theme update terminal
    }
}
