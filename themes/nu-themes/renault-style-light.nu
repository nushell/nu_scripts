export module "renault-style-light-theme" {
...
export module activate {
    export-env {
        use "renault-style-light-theme"

        renault-style-light-theme set color_config
        renault-style-light-theme update terminal
    }
}
