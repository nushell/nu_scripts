export module "ayu-mirage-simple-cursor-theme" {
...
export module activate {
    export-env {
        use "ayu-mirage-simple-cursor-theme"

        ayu-mirage-simple-cursor-theme set color_config
        ayu-mirage-simple-cursor-theme update terminal
    }
}
